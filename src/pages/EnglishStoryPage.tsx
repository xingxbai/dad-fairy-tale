          ...
          <div className="space-y-8">
            {isGenerating ? (
              ...
              <>
                ...
                {isGeneratingAudio && (
                  <div className="flex flex-col items-center justify-center space-y-2 py-4 text-blue-600 animate-pulse">
                    <div className="flex items-center space-x-2">
                      <RefreshCw className="w-5 h-5 animate-spin" />
                      <span className="text-sm font-medium italic">Daddy is preparing the story for you, please wait a moment...</span>
                    </div>
                  </div>
                )}
