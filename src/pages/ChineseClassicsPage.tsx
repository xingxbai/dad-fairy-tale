...
export function ChineseClassicsPage() {
  ...
  const handlePlayPause = async () => {
    console.log("ChineseClassicsPage handlePlayPause", { isPlaying, audioUrl: userState.currentStory?.audioUrl, voiceId });
    if (isPlaying) {
      setIsPlaying(false);
      return;
    }
    ...
    if (userState.currentStory && (voiceId || true)) {
      ...
      console.log("Generating Chinese Classics TTS...");
      try {
          ...
          <div className="space-y-8">
            {isGenerating ? (
              ...
              <>
                ...
                {isGeneratingAudio && (
                  <div className="flex flex-col items-center justify-center space-y-2 py-4 text-amber-600 animate-pulse">
